...
//    FogOfWar:array of array of Boolean;
   ...
   //  messt:real;
    ...
    /// УРОВЕНЬ, Очки
     ...
     MapLookObjs:array[1..512] of TMapLookObjs;
  ...
  Begin
    ...
    Begin
      ...
      if numb<>-1 then
         ...
         1,5..7,16,17,18,19,20,22,26,27,28,30,31..36,39,40,50..54,55..73,81,82: Begin
           MyTile:=TTile.Create(Engine);
...
procedure TMainForm.LoadSettings;
  ...
  'Language: ','MaxFPS: ','LowAnim: ','FXLight: ','Camera: ');// НАСТРОЙКИ!!!
...
procedure TMainForm.SaveSettings;
  ...
  'Windowed: ','AA: ','MouseSpeed: ','VSync: ','Console: ','BigWindow: ',
  'HighDetail: ','HighEffects: ','MusVolume: ','SndVolume: ','Cheater: ',
  'Language: ','MaxFPS: ','LowAnim: ','Camera: ');// НАСТРОЙКИ!!!
              ...
              and(abs(MapLookObjs[i].ObjY-MapLooky/100)<25) then
               Begin
                     ...
                     case MapLookObjs[i].ObjTip of
                        ...
                        2,3,8,14..17,33: needdraw:=mapshow2;
                ...
                {  if MapLookObjs[i].ObjEnabled then
                  ...
                  case MapLookObjs[i].ObjTip of
                        ...
                        2,3,8,14..17,33: DrawStretch(MMImages.Image['mmfon3'+litera],0,_x-x1-sx ,_y-y1-sy,
                            sx*3,sx*3,1,1,false,false,false,col,fxBlend);
