unit AsphyreFactory;
//---------------------------------------------------------------------------
// AsphyreFactory.pas                                   Modified: 10-Oct-2007
// Asphyre Component Factory class                                Version 1.0
//---------------------------------------------------------------------------
// Important Notice:
//
...
type
 ...
 public
  ...
  function CreateTexture(): TAsphyreTexture; virtual; abstract;
 end;
...
//---------------------------------------------------------------------------
 ...
 public
  ...
  function CreateTexture(): TAsphyreTexture;
...
//---------------------------------------------------------------------------
function TAsphyreFactory.CreateTexture(): TAsphyreTexture;
begin
 Result:= nil;

 if (Provider <> nil) then
  Result:= Provider.CreateTexture();
end;
