...
begin
    ...
    Begin
      ...
      Canvas.Font.Size:=28;
      Canvas.TextOut(Mainform.width div 2 - Canvas.TextWidth('[BETA v. 0.91]') div 2,
                     Mainform.height div 2-200, '[BETA v. 0.91]');
   ...
   //  End;
     ...
     Begin
      ...
      AsphyreTextures1.AddRenderTargets(1, 1024, 1024, false, aqHigh, alNone, false);
  ...
  Begin
    ...
    Begin
      ...
      if numb<>-1 then
         ...
         1,5..7,16,17,18,19,20,22,26,27,28,30,31..36,39,40,50..54,55..73: Begin
           MyTile:=TTile.Create(Engine);
...
begin
////
  MyCanvas.FillRect(0,0,1024,1024,Fonarcolor{cRGB1(40,40,100)},fxNone);
              ...
              and(abs(MapLookObjs[i].ObjY-MapLooky/100)<25) then
               Begin
                ...
                {  if MapLookObjs[i].ObjEnabled then
                  ...
                  case MapLookObjs[i].ObjTip of
                        1,7,10: DrawStretch(MMImages.Image['mmfon'+litera],0,_x-x1-sx ,_y-y1-sy,
                        ...
                        2,3,8,14..17: DrawStretch(MMImages.Image['mmfon3'+litera],0,_x-x1-sx ,_y-y1-sy,
                            sx*3,sx*3,1,1,false,false,false,col,fxBlend);
                        20: DrawStretch(MMImages.Image['mmfon'+litera],0,_x-x1-sx ,_y-y1-sy,
                            sx*3,sx*3,1,1,false,false,false,clwhite4,fxBlend);
                        4,11,19,9: DrawStretch(MMImages.Image['mmfon4'+litera],0,_x-x1-sx ,_y-y1-sy,
                            sx*3,sx*3,1,1,false,false,false,col,fxBlend);
 ...
 Begin
    ...
    if (TTile(Sprite).tip=73)and(TTile(Sprite).pars[3]=0)and((TTile(Sprite).pars[1]=col)or(col=8)) then
            Begin
              ...
              Begin
                  TSprite(TTile(Sprite).childs[0]).ImageName:='slot_up2'; ///.visible:=false;
