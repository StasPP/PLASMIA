...
type
     ...
     public
          ...
          property SpriteWidth: Single read FW write FW;
          property SpriteHeight: Single read FH write FH;
...
begin
     ...
     FX4 := Value.X4;
     FY4 := Value.Y4;
     FH := Value.SpriteHeight;
     FW := Value.SpriteWidth;
...
begin
  if FDrawMode<>1 then
  Begin
    if  (FX + FW/FWorldScaleX > FEngine.WorldX + FEngine.VisibleArea.Left)   and
        (FY + FH/FWorldScaleY > FEngine.WorldY + FEngine.FVisibleArea.Top)   and
     ...
     begin
          ...
          case FDrawMode of
             ...
             {  -1..0:
               if FDocenter then
               FEngine.Canvas.DrawStretch(FEngine.Image.Image[ImgName],
                         FPatternIndex,
                         round((FX + FOffsetX - FEngine.FWorldX - FScaleX*FW/2)*FWorldScaleX),
                         round((FY + FOffsetY - FEngine.FWorldY - FScaleY*FH/2)*FWorldScaleY),
                         round((FX + FOffsetX - FEngine.FWorldX + FScaleX*FW/2)*FWorldScaleX),
                         round((FY + FOffsetY - FEngine.FWorldY + FScaleY*FH/2)*FWorldScaleY),
                         FMirrorX, FMirrorY,
              ...
              FEngine.Canvas.DrawStretch(FEngine.Image.Image[ImgName],
                         ...
                         round((FX + FOffsetX - FEngine.FWorldX + FW)*FWorldScaleX),
                         round((FY + FOffsetY - FEngine.FWorldY + FH)*FWorldScaleY),
                         FMirrorX, FMirrorY,
                         CRGB4(FRed, FGreen, FBlue, FAlpha), FDrawFx);

               0: FEngine.Canvas.DrawColor1(FEngine.Image.Image[ImgName],
                         FPatternIndex,
                         ((FX + FOffsetX - FEngine.FWorldX)*FWorldScaleX),
                         ((FY + FOffsetY - FEngine.FWorldY)*FWorldScaleY),
              ...
              { 1: FEngine.Canvas.DrawRotateC(FEngine.Image.Image[ImgName],
               ...
               2: FEngine.Canvas.DrawColor4(FEngine.Image.Image[ImgName],
                         FPatternIndex,
                         round((FX + FOffsetX + round(FWorldX - FEngine.FWorldX))*FWorldScaleX),
                         round((FY + FOffsetY + round(FWorldY - FEngine.FWorldY))*FWorldScaleY) ,
                         FScaleX*FWorldScaleX, FScaleY*FWorldScaleY, FDoCenter,
                         FMirrorX, FMirrorY,
  ...
  Begin
    ...
    if  (FX+FW/FWorldScaleX > FEngine.WorldX + FEngine.VisibleArea.Left)   and
        (FY+FH/FWorldScaleY > FEngine.WorldY + FEngine.FVisibleArea.Top)   and
        (FX-FW/FWorldScaleX < FEngine.WorldX + FEngine.FVisibleArea.Right) and
        (FY-FH/FWorldScaleY < FEngine.WorldY + FEngine.FVisibleArea.Bottom)then

                  FEngine.Canvas.DrawRotateC(FEngine.Image.Image[ImgName],
                         FPatternIndex,
                         ((FX + FWorldX + FOffsetX - FEngine.FWorldX)*FWorldScaleX),
                         ((FY + FWorldY + FOffsetY - FEngine.FWorldY)*FWorldScaleY),
                         FAngle,
          ...
          pmPingPong: // 12345432123454321
               begin
                    ...
                    begin
                         ...
                         if (FAnimPos > FAnimStart + FAnimCount-1) then
                              FAnimPos:= FAnimStart + FAnimCount-1;
                    end
                    else
                    begin
