...
//---------------------------------------------------------------------------
uses
 Windows, {Types, {}Classes, SysUtils, Direct3D9, DXBase, AsphyreDef, AsphyreMath,
...
//---------------------------------------------------------------------------
 ...
 public
  ...
  {Gurroa:{}property AlphaBlend: Boolean read FAlphaBlend write FAlphaBlend;{}
 end;
...
begin
 if (Direct3DDevice = nil) then Exit;
  ...
  begin
    ...
    if not FAlphaBlend then
    begin
      SetRenderState(D3DRS_SRCBLEND,  D3DBLEND_ONE);
      SetRenderState(D3DRS_DESTBLEND, D3DBLEND_ZERO);
      SetRenderState(D3DRS_BLENDOP,  D3DBLEND_ONE);
