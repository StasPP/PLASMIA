...
var
     ...
     ShowLas,Disableback,ShowZones:boolean;
...
///
 ...
 if Ramka2.Left=0 then
 Begin
  if (Ramka2.Right<>0)then
    begin
      MiniBitMap.Canvas.Draw(0,Ramka1.Bottom-200,Mainform.Image1.Picture.Graphic);
      MiniBitMap.Canvas.Draw(0,Ramka2.Top,Mainform.Image1.Picture.Graphic);
    end;
 End else
 Begin
  MiniBitMap.Canvas.Draw(Ramka1.Right-200,0,Mainform.Image1.Picture.Graphic);
  MiniBitMap.Canvas.Draw(Ramka2.Left,0,Mainform.Image1.Picture.Graphic);
 End;
...
if images2.Find('Minimap')<>-1 then
  ...
  End;
    MiniBitMap.Canvas.Draw(0,0,Mainform.Image1.Picture.Graphic);
  Ramka1.Left:=0;
  Ramka1.Top:=0;
...
End;
 ...
 if (tip=8) and (pars[1]<>'') and(pars[2]<>'') and (parnames[1]='Width') and ShowZones  then
 Begin
  i:=10;
  if name='closed' then
    i:=0;
  ...
  crgb1(250,i*25,i*25,200),crgb1(250,i*25,i*25,50),FxBlend);
 End;

  if (tip=22) and ((pars[1]='1') or (pars[1]='2')or (pars[1]='3')or
      (pars[1]='4')or (pars[1]='5') or (pars[1]='6')or (pars[1]='7'))and ShowZones  then
 Begin
 ...
 if (tip=23) and (pars[1]<>'') and(pars[2]<>'') and (parnames[1]='DistY')and ShowZones  then
 Begin
