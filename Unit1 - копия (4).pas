...
var
    ...
    // Survival:Boolean;
     ...
     mb1,mb2,mb3,ScenarioTextBegin,ScenarioTextEnd,Hispeed:integer;
...
begin
    ...
    Begin
      ...
      Canvas.Font.Size:=24;
      Canvas.TextOut(Mainform.width div 2 - Canvas.TextWidth('[BETA v. 0.95]') div 2,
                     Mainform.height div 2-200, '[BETA v. 0.95]');
...
procedure TMainForm.LoadSettings;
  ...
  'Language: ','MaxFPS: ','LowAnim: ','FXLight: ');// НАСТРОЙКИ!!!
...
Begin
   ...
   Begin
    ...
    if (leveltime>=420)and(health<=0)and(fade1<255) then
    Begin
    ...
    if (leveltime>=420)and(health>0) then
      begin    // leveltime:=300;
        //levelmission:=0;
        health:=-100;
        BoomTime:=100;
      ...
      begin
       ...
       DrawStretch(HudImages.Image['shieldfon'],0,
        ...
        DrawStretch(HudImages.Image['shield_'+inttostr(dop4+2)],0,
            ...
            trunc((misshift+250)*ResolutionScaleY2+(128)*ResolutionScaleY),false,false,
            cRGB4(redw[1],greenw[1],bluew[1],
                  trunc(levelmissionshow*(((420-leveltime)-dop4*42))/42)),fxBlend);
      ...
      DrawStretch(HudImages.Image['mission'+inttostr(levelmissiontip)
       ...
       Begin
        ...
        DrawStretch(HudImages.Image['mission_'+inttostr(levelmissiontip)],0,
            trunc((6-224+levelmissionshow-(312-met)/10)*ResolutionScaleX),
            trunc((294+misshift-(312-met)/10)*ResolutionScaleY2),
            trunc((6-192+32+levelmissionshow+(312-met)/10)*ResolutionScaleX),
      ...
      if levelmissiontip=1 then
        st:=inttostr(5-levelmission)+'/5'//+inttostr(lmmax)
            ...
            begin
              ...
              Begin
                st:='';
                dop4:=trunc((420-leveltime)/60);
                st:= inttostr(dop4)+':';

                dop4:=trunc((420-leveltime)-60*trunc((420-leveltime)/60));
                if dop4<10 then
                   st:= st+'0';
                st:= st+inttostr(dop4);
              End
