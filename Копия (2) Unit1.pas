...
begin
 ...
 if (EnmName= 'enm2')or(AITip=10) then
  if EnmTicks3>=1 then
  Begin
    allcrazy2:=10;
   ...
   if (enmName='Boss1') then
    ...
    Begin
       // Mainform.SoundSystem2.Play('boom2.wav',false);   //////////// EXPL
        ...
        smessage:=language[181+3-bosscount];
        smessagetime:=300;
      ...
      if EnmSubCount>0 then
       ...
       Begin
        ...
        if (TArmosprite(sprite).col=enmweap)or(AITip=5)or(AITip=6)or(TArmosprite(sprite).col=8) then
         if not((TArmosprite(sprite).ArmoType<>aball)and(AITip=10)) then
...
begin
 ...
 Begin
      ...
      if (Hud_CurrentZone=i)and(j<>0 ) then
      Begin
        tx:=IntToStr(k);
               ...
               Begin
                 ...
                 Begin
                  ...
                  case MapLookObjs[i].ObjTip of
                        ...
                        21: DrawStretch(MMImages.Image['mmfon5'],0,_x-x1-sx ,_y-y1-sy,
                            sx*3,sx*3,1,1,false,false,false,col,fxBlend);
                  end;
